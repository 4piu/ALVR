...
impl Event {
    ...
    pub fn message(&self) -> String {
        match &self.event_type {
            ...
            EventType::StatisticsSummary(stats_summary) => serde_json::to_string(stats_summary).unwrap(),
            EventType::GraphStatistics(graph_stats) => serde_json::to_string(graph_stats).unwrap(),
